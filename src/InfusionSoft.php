...
class InfusionSoft {
    /**
     * @var string URL all REST requests are sent to
     */
    ...
    {
        if ( ! $this->httpClient) {
            return new Infusionsoft\Http\GuzzleHttpClient($this->debug, $this->getHttpLogAdapter());
        }
    ...
    {
        if ( ! $this->serializer) {
            return new \Infusionsoft\Http\InfusionsoftSerializer();
        }
